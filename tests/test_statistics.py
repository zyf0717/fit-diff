...
class TestGetBiasAgreementStats:
    """Test cases for get_bias_stats function."""
    ...
    def test_get_bias_stats_success(self):
        """Test successful bias agreement stats calculation."""
        aligned_df = self.create_aligned_data()

        # Test
        result = get_bias_stats(aligned_df, "heart_rate")
    ...
    def test_get_bias_stats_invalid_input(self):
        """Test with invalid input."""
        assert get_bias_stats(None, "heart_rate") is None
        assert get_bias_stats(pd.DataFrame(), "heart_rate") is None


class TestGetErrorMagnitudeStats:
    """Test cases for get_accuracy_stats function."""
    ...
    def test_get_accuracy_stats_success(self):
        """Test successful error magnitude stats calculation."""
        aligned_df = self.create_aligned_data()

        # Test
        result = get_accuracy_stats(aligned_df, "heart_rate")
    ...
    def test_get_accuracy_stats_invalid_input(self):
        """Test with invalid input."""
        assert get_accuracy_stats(None, "heart_rate") is None
        assert get_accuracy_stats(pd.DataFrame(), "heart_rate") is None


class TestGetCorrelationStats:
    """Test cases for get_agreement_stats function."""
    ...
    def test_get_agreement_stats_success(self):
        """Test successful correlation stats calculation."""
        aligned_df = self.create_aligned_data()

        # Test
        result = get_agreement_stats(aligned_df, "heart_rate")
    ...
    def test_get_agreement_stats_invalid_input(self):
        """Test with invalid input."""
        assert get_agreement_stats(None, "heart_rate") is None
        assert get_agreement_stats(pd.DataFrame(), "heart_rate") is None
